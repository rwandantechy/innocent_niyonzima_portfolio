  ...
  return (
    <>
      ...
      <section className="home-journey-section">
        <div className="container">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 style={{ textAlign: 'center', marginBottom: 32 }}>My Journey</h2>
            <JourneyTimeline />
          </motion.div>
        </div>
      </section>
      ...
      <section className="container" style={{ paddingBottom: 60 }}>
        ...
        >
          <h2>Proof & Social Validation</h2>
          <p className="muted">Recommendations from research, operations, and client work.</p>
        </motion.div>
        <SocialProofSection />
      </section>
      ...
      <section ref={projectsRef} className="container" style={{ paddingBottom: 80 }}>
        ...
        >
          ...
          <p className="muted" style={{ fontSize: '1.1rem' }}>
            Production systems with real users, payments, and operational ownership.
          </p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                {getCaseStudy(project.id) && (
                  <Link to={`/projects/${project.id}`} className="btn btn-secondary" style={{ marginTop: 16 }}>
      ...
      <section className="container" style={{ paddingBottom: 80 }}>
        ...
        >
          ...
          <p className="muted">Lessons from building and operating real systems.</p>
        </motion.div>
        ...
        <div className="container">
          <div className="cta-content">
            ...
            <p className="muted" style={{ fontSize: '1.1rem', marginBottom: 32 }}>
              Seeking software engineering roles. I bring production ownership, systems thinking, and 76,000+ users of proof.
            </p>
